#pragma checksum "F:\Projects\OnGIT\CreditRequestSystem\WebApp\Views\Project\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ae72e678b953f092b4451d2d6761243b2bb7829a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ae72e678b953f092b4451d2d6761243b2bb7829a", @"/Views/Project/Index.cshtml")]
...
#line hidden
            ...
            DefineSection("styles", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "ae72e678b953f092b4451d2d6761243b2bb7829a5148", async() => {
                }
                );
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "ae72e678b953f092b4451d2d6761243b2bb7829a6480", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
#line 46 "F:\Projects\OnGIT\CreditRequestSystem\WebApp\Views\Project\Index.cshtml"
                Write(ViewData["Title"]);

#line default
#line hidden
            EndContext();
            BeginContext(1084, 254, true);
            WriteLiteral("</h1>\r\n            </div>\r\n            <div class=\"col-sm-6\">\r\n                <ol class=\"breadcrumb float-sm-right\">\r\n                    <li class=\"breadcrumb-item\"><a href=\"#\">Trang chủ</a></li>\r\n                    <li class=\"breadcrumb-item active\">");
            EndContext();
            BeginContext(1340, 17, false);
#line 51 "F:\Projects\OnGIT\CreditRequestSystem\WebApp\Views\Project\Index.cshtml"
                                                   Write(ViewData["Title"]);

#line default
#line hidden
            EndContext();
            BeginContext(1358, 6105, true);
            WriteLiteral(@"</li>
                </ol>
            </div>
        </div>
    ...
    <div class=""modal-dialog "" id=""form_import_project"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                <h5 class=");
            WriteLiteral(@"""modal-title"" id=""uploadModalLabel"">Tải lên dữ liệu chương trình/dự án/dịch vụ</h5>

            </div>
            <div class=""modal-body"">
                <p><strong>Bước 1:</strong> Tải file mẫu tại đây - <a href=""#"" class=""text-primary"">File mẫu</a></p>
...
<div id=""cntModalListProject"">
    <div class=""modal fade"" id=""ListPr");
            WriteLiteral(@"ojectModal"" tabindex=""-1"" aria-labelledby=""ListProjectModalLabel"" aria-hidden=""true"" data-backdrop=""static"" data-keyboard=""false"">
        <div class=""modal-dialog modal-xl"">
            <div class=""modal-content"">
                <div class=""modal-header pt-2 pb-2"">
                    <h5 class=""modal-title"" id=""ListProjectModalLabel"">Tải lên dữ liệu chương trình/dự án/dịch vụ</h5>
            ...
            WriteLiteral(@"              <tr>
                                        ...
                                        <th scope=""col"" class="""">Tên dự án</th>
...
<div id=""cntModalResultImport"">
   ...
   ");
            WriteLiteral(@"     <div class=""modal-dialog modal-xxl"">
            <div class=""modal-content"">
                <div class=""modal-header pt-2 pb-2"">
                            ...
                            <table class=""table table-root"">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope=""col"" class="""">Căn cứ pháp lý</th>
                                        <th scope=""col"" class="""">Thời gian bắt đầu</th>
                                        <th scope=""col"" class="""">Thời gia");
            WriteLiteral(@"n kết thúc</th>
                                        <th scope=""col"" class="""">Tổng tiền</th>
                                        <th scope=""col"" class="""">Ghi chú</th>
                                    </tr>
                                </thead>
...
");
            ...
            DefineSection("scripts", async() => {
                ...
                WriteLiteral("\r\n    ");
                EndContext();
                BeginContext(10799, 63, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ae72e678b953f092b4451d2d6761243b2bb7829a19599", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ae72e678b953f092b4451d2d6761243b2bb7829a20857", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#fileInputProject').on('change', function () {
                ...
                if (file) {
                    ...
                    $.ajax({
                        url: '/FileUp");
                WriteLiteral(@"load/UploadFile', // Đường dẫn đến API xử lý file
                        type: 'POST',
                        data: fileData,
                        contentType: false,
                        processData: false,
                            ...
                            if (response.success == true && response.fileNameAttactId > 0) {
                                const html = `
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href=""$");
                WriteLiteral(@"{response.filePath}"" target=""_blank"">${response.fileName}</a>
                                                        </td>
      ...
      ");
                WriteLiteral(@"                      toastr.success('Tải file thành công!', 'Thành công', { positionClass: ""toast-top-center"" });
                        },
                        error: function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            i");
                WriteLiteral(@"f (response.success) {
    ...
    ");
                WriteLiteral(@"                type: 'POST',
                    ...
                    error: function (xhr, status, error) {
                        // Xử lý khi có lỗi xảy ");
                WriteLiteral(@"ra trong quá trình gọi AJAX
        ...
        function showhideSoTienDaSuDung() {
            ...
            if (ishow == ""show"") {
                ...
                d");
                WriteLiteral(@"ocument.getElementById(""a_luy_ke"").setAttribute('data-value', 'hide');
       ...
       ");
                WriteLiteral(@"             // call ajax delete
                    $.ajax({
                        ...
                        error: function (xhr, status, error) {
                            console.error(""Có lỗi khi tải nội dung mod");
                WriteLiteral(@"al: "", error);
                            alert(""Lỗi tải modal, vui lòng thử lại sau."");
                        }
                    });
 ...
 ");
                WriteLiteral(@"       function readFileImport() {
                ...
                WriteLiteral(@"poneAjax = [];
                    ...
                    if (response.status = ""Success"") {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            htmlAppend += `<td>` + (data[i].timeStart == null ? """" : moment(data[i].timeStart).");
                WriteLiteral(@"format('DD/MM/YYYY')) + `</td>`;
        ...
        function showModal() {
            $('#");
                WriteLiteral(@"cntModalListProject #ListProjectModal').modal().show();
            caclCheckTotal();
            ...
            $('#cntModalListProject #ListProjectModal [name=""checkAllRow""]').on('click', function () {
                if ($(this).is(':checked')) {
                    $('#cntModalListProje");
                WriteLiteral(@"ct #ListProjectModal #lst-data-info [name=""checkRow""]').prop('checked', true);
                    dataSubmit = dataResponeAjax;
                }
                else {
                    $('#cntModalListNV #ListNVModal #lst-data-info [name=""checkRow""]').prop('checked', false);
                    dataSubmit = [];
                }
                caclCheckTotal();
            })
        ...
        function ImportDuAn() {
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend: function () {
                    $('#cntModalListNV #ListNVModal').modal('hide');
  ...
  ");
                WriteLiteral(@"              success: function (response) {
                    ...
                    Swal.fire({
                        ...
                        text: dataSFSubmit.length + "" dòng dữ liệu"",
                    ...
                    for (var i = 0; i < response.data.length; i++) {
                        htmlAppend += `<tr>`;
                        htmlAppend += `<td>` + response.data[i].data.MaNhanVien + `</td>`;
                        htmlAppend += `<td>` + response.data[i].data.HoTen + `</td>`;
                        htmlAppend += `<td>` + response.data[i].data.ViTri + `</td>`;
                        htmlAppend += `<td>` + (response.data[i].data.NgaySinh == null ? """" : moment(response.data[i].data.NgaySinh).format('DD/MM/YYYY')) + `</td>`;
                        htmlAppend += `<td>` + response.data[i].data.S");
                WriteLiteral(@"DT + `</td>`;
                        htmlAppend += `<td>` + (response.data[i].data.HoTenThanNhan == null ? """" : response.data[i].data.HoTenThanNhan) + `</td>`;
                        htmlAppend += `<td>` + (response.data[i].data.NgaySinhThanNhan == null ? """" : moment(response.data[i].data.NgaySinhThanNhan).format('DD/MM/YYYY')) + `</td>`;
                        htmlAppend += `<td>` + (response.data[i].data.CCCDThanNhan == null ? """" : response.data[i].data.CCCDThanNhan) + `</td>`;
                        htmlAppend += `<td>` + (response.data[i].data.MoiQuanHe == null ? """" : response.data[i].data.MoiQuanHe) + `</td>`;
                        htmlAppend += `<td>` + (response.data[i].data.TrungTam == null ? """" : response.data[i].data.TrungTam) + `</td>`;
                ...
                WriteLiteral(@"nd += `</tr>`;
                    ...
                    $('#cntModalResultImport #ListNVModalResultImport #lst-data-info').html(htmlAppend);

                    $('#ListNVModalResultImport').modal().show();
                },
                error: function (jqXHR, textStatus, errorThrown) {
