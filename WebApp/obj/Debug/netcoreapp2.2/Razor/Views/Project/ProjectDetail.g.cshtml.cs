#pragma checksum "F:\Projects\OnGIT\CreditRequestSystem\WebApp\Views\Project\ProjectDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "eb925d409073ed86b24c80a480c5a2f862d32a1e"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"eb925d409073ed86b24c80a480c5a2f862d32a1e", @"/Views/Project/ProjectDetail.cshtml")]
...
#line 11 "F:\Projects\OnGIT\CreditRequestSystem\WebApp\Views\Project\ProjectDetail.cshtml"
                Write(ViewData["Title"]);

#line default
#line hidden
            EndContext();
            BeginContext(300, 16744, true);
            WriteLiteral(@"</h1>
            </div>
            <div class=""col-sm-6"">
    ...
    <div class=""card card-warning card-outline card-tabs"">
        <div class=""card-header p-0 pt-1 border-bottom-0"">
            <ul class=""nav nav-tabs"" id=""custom-tabs-three-tab"" role=""tablist"">
                ...
                <li class=""nav-item"">
                    <a cla");
            WriteLiteral(@"ss=""nav-link"" id=""project-history-tab"" data-toggle=""pill"" href=""#project-history-tab-content"" role=""tab"" aria-controls=""custom-tabs-three-messages"" aria-selected=""false"">LỊCH SỬ ĐIỀU CHỈNH</a>
                </li>
        ...
        <div class=""card-body"">
                        ...
                        <div class=""row"">
                            <div class=""col-sm-6"">
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
                                        <input type=""text"" class=""form-control"" value="""" name=""ma_du_an""  id=""a_ma_du_an"" /");
            WriteLiteral(@">
                                    </div>
                                </div>
                                <div class=""form-group row"">
                                ...
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
                                        <input type=""text"" class=""form-control"" value="""" id=""a_can_cu_phap_ly"" name=""can_cu_phap_ly"" />
                                    </div>
                                </div>
               ");
            WriteLiteral(@"                 <div class=""form-group row"">
                                    ...
                                    <div class=""input-group-append col-md-8"">
                                        <select class=""form-control"" name=""thoi_gian_bat_dau"" id=""a_thoi_gian_bat_dau"">
                                          <option>2022</option>
                                          <option>2023</option>
                                      ...
                                      <h3>-</h3>
                                        <select class=""form-control"" name=""thoi_gian_ket_thuc"" id=""thoi_gian_ket_thuc"">
                                            <option>2022</option>
                                            <option>2023</option>
                                            <opt");
            WriteLiteral(@"ion selected>2024</option>
                                            <option>2025</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
                                        <div class=""input-group date"">
                                            <input type=""text"" id=""DateRequest"" disabled=");
            WriteLiteral(@"""disabled"" name=""DateRequest"" value=""10/11/2024"" class=""form-control"">
                            ...
                            <div class=""col-sm-6"">
                                ...
                                <div class=""form-group row"">
                                    <label cl");
            WriteLiteral(@"ass=""col-md-4 col-form-label"">Đã sử dụng (luỹ kế)</label>
                                    <div class=""col-md-7"">
                                ...
                                <div class=""form-group row"">
                 ");
            WriteLiteral(@"                   <label class=""col-md-4 col-form-label"">Trạng thái</label>
                                    <div class=""col-md-8"">
                                ...
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
                                        <table class=""table"" width=""100%"">
                                            <tr>
            ");
            WriteLiteral(@"                                    <td width=""40px"" style=""text-align:center;""><span class=""fa fa-download""></span></td>
       ...
       ");
            WriteLiteral(@"                         <td>Báo cáo viên</td>
...
<div class=""modal fade show"" data-backdrop=""static"" id=""modal-project-itemline"" aria-modal=""true"" role=""dialog"">
   ...
   ");
            WriteLiteral(@"                             <option>Mua sắm chuyên môn</option>
                            </select>
                        </div>
...
");
  ...
  ");
        ...
        fun");
                WriteLiteral(@"ction validateData() {
            var resultValid = $(""#frmCreateProject"").validate({
                ...
                messages: {
                    ...
                    ""ma_du_an"": ""Mã chương trình/dự án/dịch vụ không");
